<?php
if ( !class_exists( 'Withemes_Framework_Metabox' ) ) :
/**
 * Metabox Framework Developed by WiThemes
 *
 * @since 1.0
 */
class Withemes_Framework_Metabox
{   
    ...
    private static $prefix = '_withemes_';
    ...
    public function init() {
        ...
        add_filter ( 'withemes_metaboxes', array( $this, 'prefix_metaboxes' ), 100 );
    ...
    function css() {
        ...
        foreach ( (array) $withemes_metaboxes as $metabox ) {
    ...
    function metabox_save( $post_id, $post, $update ) {
        ...
        if ( empty( $nonce ) || ! wp_verify_nonce( $nonce, "withemes-metabox-{$post_id}" ) )
            return;

        // Before save action
        // We can alter value here or validate the data
        do_action( 'withemes_before_save_post', $post_id, $post );
        
        // Retrieve metaboxes
        $metaboxes = apply_filters( 'withemes_metaboxes', array() );
        ...
        foreach ( $metaboxes as $metabox ) {
            ...
            if ( !get_post_meta( $post_id, '_withemes_saved_once', true ) ) {
                add_post_meta( $post_id, '_withemes_saved_once', true );
            }
    ...
    function render_metabox ( $post, $metabox ) {
        ...
        wp_nonce_field( "withemes-metabox-{$post->ID}" , "_nonce_metabox_{$post->ID}" );
        
        ?>

        <div class="withemes-metabox">
                ...
                foreach ( $fields as $field ) {
                    ...
                    if ( !isset( $field[ 'field_id' ] ) ) {
                        ...
                        if ( isset( $field[ 'id' ] ) ) {
                            ...
                            $field[ 'field_id' ] = "withemes-field-{$metabox['id']}-{$field['id']}";
    ...
    function render_field ( $field, $post ) {
        ...
        if ( $post_id ) {
            $saved = get_post_meta( $post_id, '_withemes_saved_once', true );
        } else {
            $saved = false;
        }
...
<div class="withemes-metabox-field field-<?php echo esc_attr( $type ); ?>"<?php echo $id_attr; ?> <?php echo $data_attr; ?> data-id="<?php echo esc_attr( $id ); ?>">
    ...
    function upload_field( $field, $id, $value ) {
        ...
        $upload_button_name = $file ? esc_html__( 'Change File','simple-elegant' ) : esc_html__( 'Upload','simple-elegant' );
        
        $file_type = isset( $field[ 'file_type' ] ) ? $field[ 'file_type' ] : '';
        
        ?>

        <div class="withemes-upload-wrapper"<?php if ($file_type) echo ' data-type="' . esc_attr( $file_type ) . '"'; ?>>
            ...
            <figure class="file-holder<?php if($file) echo ' has-file'; ?>">
                ...
                <a href="#" rel="nofollow" class="remove-file-button" title="<?php esc_html_e( 'Remove File', 'simple-elegant' );?>">&times;</a>
    ...
    function image_field( $field, $id, $value ) {
        ...
        $upload_button_name = $image ? esc_html__( 'Change Image','simple-elegant' ) : esc_html__( 'Upload Image','simple-elegant' );
        
        ?>

        <div class="withemes-upload-wrapper">
            ...
            <figure class="image-holder">
                ...
                <a href="#" rel="nofollow" class="remove-image-button" title="<?php esc_html_e( 'Remove Image', 'simple-elegant' );?>">&times;</a>
        ...
        <div class="withemes-upload-wrapper">
            ...
            <div class="images-holder">
                ...
                <figure class="image-unit" data-id="<?php echo esc_attr( $image ); ?>">
                    ...
                    <a href="#" rel="nofollow" class="remove-image-unit" title="<?php esc_html_e( 'Remove Image', 'simple-elegant' );?>">&times;</a>
            ...
            <input type="button" class="upload-images-button button button-primary" value="<?php echo esc_html__( 'Upload Images', 'simple-elegant' ) ;?>" />

        </div><!-- .withemes-upload-wrapper -->
    ...
    function color_field( $field, $id, $value ) {
        ...
        <div class="withemes-colorpicker-wrapper">
            
            <input type="text" class="withemes-colorpicker" name="<?php echo $id; ?>" id="<?php echo $id; ?>" value="<?php echo esc_attr( $value ); ?>" />
            
        </div><!-- .withemes-colorpicker -->
...
<div class="review-wrapper">
    ...
    <div class="review-list">
        ...
        <div class="review" data-id="<?php echo $id;?>" data-order="<?php echo $i; ?>">
            ...
            <div class="review-criterion" data-property="criterion">
                ...
                <input type="text" class="widefat" id="<?php echo $id; ?>[<?php echo $i;?>][criterion]" name="<?php echo $id; ?>[<?php echo $i;?>][criterion]" value="<?php echo esc_attr( $criterion ) ;?>" placeholder="<?php echo esc_html__( 'Criterion: Design, Usability...', 'simple-elegant' ); ?>" />

            </div><!-- .review-criterion -->

            <div class="review-score" data-property="score">

                <input type="text" class="widefat" id="<?php echo $id; ?>[<?php echo $i;?>][score]" name="<?php echo $id; ?>[<?php echo $i;?>][score]" value="<?php echo esc_attr( $score ) ;?>" placeholder="<?php echo esc_html__( 'Score: 0 - 10', 'simple-elegant' ); ?>" />

            </div><!-- .review-score -->
            
            <button class="button remove-review" type="button"><?php echo esc_html( 'Remove', 'simple-elegant' ); ?></button>
    ...
    <button class="button new-review" type="button"><?php echo esc_html( 'Add New Criterion', 'simple-elegant' ); ?></button>
...
<div class="slides-wrapper">
    ...
    <div class="slides-list">
        ...
        <div class="slide" data-id="<?php echo $id;?>" data-order="<?php echo $i; ?>">
            ...
            <div class="slide-image" data-property="image">
                ...
                <?php
                $attachment = !empty($image) ? wp_get_attachment_image($image,'medium') : null;
                $upload_button_name = $attachment ? esc_html__( 'Change Image','simple-elegant' ) : esc_html__( 'Upload Image','simple-elegant' );
                ?>
            ...
            <div class="slide-options">
                ...
                <label for="<?php echo $id; ?>[<?php echo $i;?>][title]" class="slide-title" data-property="title">
                    ...
                    <span><?php echo esc_html__( 'Title', 'simple-elegant' ); ?></span>
                    <input type="text" id="<?php echo $id; ?>[<?php echo $i;?>][title]" name="<?php echo $id; ?>[<?php echo $i;?>][title]" value="<?php echo esc_attr( $title ) ;?>" placeholder="<?php echo esc_html__( 'Slide title', 'simple-elegant' ); ?>" />
                    
                </label>
                
                <label for="<?php echo $id; ?>[<?php echo $i;?>][desc]" class="slide-desc" data-property="desc">
                    
                    <span><?php echo esc_html__( 'Description', 'simple-elegant' ); ?></span>
                    <textarea id="<?php echo $id; ?>[<?php echo $i;?>][desc]" name="<?php echo $id; ?>[<?php echo $i;?>][desc]" placeholder="<?php echo esc_html__( 'Slide Description', 'simple-elegant' ); ?>"><?php echo $desc ;?></textarea>
                    
                </label>
                
                <label for="<?php echo $id; ?>[<?php echo $i;?>][url]" class="slide-url" data-property="url">
                    
                    <span><?php echo esc_html__( 'Slide link', 'simple-elegant' ); ?></span>
                    <input type="url" id="<?php echo $id; ?>[<?php echo $i;?>][url]" name="<?php echo $id; ?>[<?php echo $i;?>][url]" value="<?php echo esc_attr( $url ) ;?>" placeholder="<?php echo esc_html__( 'Slide link', 'simple-elegant' ); ?>" />
                    ...
                    <div for="<?php echo $id; ?>[<?php echo $i;?>][url_target]" class="slide-url-target" data-property="url_target">
                        ...
                        <select id="<?php echo $id; ?>[<?php echo $i;?>][url_target]" name="<?php echo $id; ?>[<?php echo $i;?>][url_target]">
                            ...
                            <option value="_self"<?php selected( $url_target, '_self' ); ?>><?php echo esc_html__( 'Same Tab', 'simple-elegant' ); ?></option>
                            <option value="_blank"<?php selected( $url_target, '_blank' ); ?>><?php echo esc_html__( 'New Tab', 'simple-elegant' ); ?></option>
            ...
            <button class="button remove-slide" type="button"><?php echo esc_html( 'Remove', 'simple-elegant' ); ?></button>
    ...
    <button class="button button-primary new-slide" type="button"><?php echo esc_html( 'New Slide', 'simple-elegant' ); ?></button>
...
Withemes_Framework_Metabox::instance()->init();

endif; // class exists

if ( ! function_exists( 'withemes_metaboxes' ) ) :
/**
 * Returns list of metaboxes
 *
 * @since 1.0
 */
function withemes_metaboxes() {
    
    return apply_filters( 'withemes_metaboxes', array() );
