...
if ( !class_exists ( 'Withemes_Widget' ) ) :

class Withemes_Widget extends WP_Widget
{
    ...
    function display_form( $fields = array(), $instance = array() ) {
        ...
        foreach ( $fields as $field ) {
            ...
            if ( $field['type'] == 'group' ) {
                ...
                $this->withemes_form_group( $field, $instance );
                continue;
            }
            // other types
     ...
     * @return void
     */
    function withemes_form_heading( $field = array(), $value = null ) {
?>
    <h4 class="withemes-widget-heading"><?php echo esc_html( $field['name'] ); ?></h4>
    <?php if ( $field['desc'] ) : ?>
    <small><?php echo wp_kses( $field['desc'] , withemes_allowed_html() ); ?></small>
    <?php endif;
    }
     ...
     * @return void
     */
    function withemes_form_group( $field = array(), $instance = array() ) {
?>
<div class="widget widget-group open" id="group-<?php echo esc_attr($this->get_field_id( $field['id'] ) ); ?>">
    <div class="widget-top">
        <div class="widget-title-action">
            ...
            <a class="widget-control-edit hide-if-js" href="widgets.php?editwidget=group-<?php echo esc_attr($this->get_field_id( $field['id'] ) ); ?>">
                <span class="edit"><?php esc_html_e('Edit','simple-elegant');?></span>
                <span class="add"><?php esc_html_e('Add','simple-elegant');?></span>
    ...
    <div class="widget-inside" style="display:block;">
        ...
        <?php if ( $field['desc'] ) : ?>
        <small class="widget-group-content-desc"><?php echo wp_kses( $field['desc'] , withemes_allowed_html() ); ?></small>
        <?php endif; ?>
...
<?php
     ...
     * @return void
     */
    function withemes_form_text( $field = array(), $value = null ) {
?>
<p>
     ...
     * @return void
     */
    function withemes_form_color( $field = array(), $value = null ) {
?>
<div class="withemes-colorpicker-wrapper">
    <label for="<?php echo esc_attr($this->get_field_id( $field['id'] ) ); ?>"><?php echo esc_html( $field['name'] ); ?></label>
    <input class="widefat withemes-colorpicker" id="<?php echo esc_attr( $this->get_field_id( $field['id'] ) ); ?>" name="<?php echo esc_attr($this->get_field_name( $field['id'] )); ?>" type="text" value="<?php echo esc_attr( $value ); ?>" />
    <?php if ( $field['desc'] ) : ?>
    <small><?php echo wp_kses( $field['desc'] , withemes_allowed_html() ); ?></small>
    <?php endif; ?>
</div>
     ...
     * @return void
     */
    function withemes_form_textarea( $field = array(), $value = null ) {
?>
<p>
    <label for="<?php echo esc_attr($this->get_field_id( $field['id'] ) ); ?>"><?php echo esc_html( $field['name'] ); ?></label>
     ...
     * @return void
     */
    function withemes_form_select( $field = array(), $value = null ) {
...
<?php   
     ...
     * @return void
     */
    function withemes_form_checkbox( $field = array(), $value = false ) {
?>
<p>
    ...
    <?php if ( $field['desc'] ) { ?>
    <br><small><?php echo wp_kses( $field['desc'] , withemes_allowed_html() ); ?></small>
    <?php } ?>
</p>
<?php }
     ...
     * @return void
     */
    function withemes_form_radio( $field = array(), $value = false ) {
?>
<p>
...
<?php }
     ...
     * @return void
     */
    function withemes_form_image_select( $field = array(), $value = false ) {
?>
<p class="withemes-image-select">
...
<?php }
     ...
     * @return void
     */
    function withemes_form_image( $field = array(), $value = false ) {
...
<?php }
     ...
     * @return void
     */
    function withemes_form_images( $field = array(), $value = false ) {
        ?>
<div class="withemes-upload-wrapper multiple">
        ...
        if ( !empty($value) ) {
            ...
            foreach ( $ids as $id ) {
                if ( $image = wp_get_attachment_image_src( $id, 'thumbnail') ) {
                    ...
                    echo '<a href="#" class="remove-image-button" title="'. esc_html__( 'Remove Image', 'simple-elegant' ) .'">&times;</a>';
                    echo '</div>';
                }
            }
        }
    ...
    <input type="hidden" class="media-result" id="<?php echo $this->get_field_id( $field['id'] ); ?>" name="<?php echo $this->get_field_name( $field['id'] ); ?>" value="<?php echo esc_attr( $value ); ?>" />
    <input id="<?php echo $this->get_field_id( $field['id'] . '-upload' ); ?>" type="button" class="upload-images-button button" value="<?php echo esc_html__('Upload Images','simple-elegant');?>" />
...
<?php }
     ...
     * @return void
     */
    function withemes_form_date( $field = array(), $value = null ) {
?>
<p>
    <label for="<?php echo esc_attr($this->get_field_id( $field['id'] ) ); ?>"><?php echo esc_html( $field['name'] ); ?></label>
     ...
     * @return void
     */
    function withemes_form_html( $field = array(), $value = null ) {
