<?php
if ( ! class_exists( 'Withemes_Menu_Item_Custom_Fields' ) ) :
/**
 * Menu Item Custom Fields
 *
 * @since 1.0
 */
class Withemes_Menu_Item_Custom_Fields 
{
	...
	public function init() {
		...
		self::$fields[] = array(
			'id'		=>	'mega',
			'name'		=>	esc_html__( 'Enable Mega Menu?', 'simple-elegant' ),
			'type'		=>	'checkbox',
		);
...
Withemes_Menu_Item_Custom_Fields::instance()->init();
