 ...
 */
$el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $parallax = $parallax_speed = $video_type = $video_url = $mp4 = $webm = $overlay = $align = $css_animation = '';
$disable_element = '';
$output = $after_output = '';
