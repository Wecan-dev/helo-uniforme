<?php
/**
 * Customized VC Row by Simple & Elegant theme to improve parallax & video background
 *
 * @since 1.0
 */
if ( ! defined( 'ABSPATH' ) ) {
 ...
 *
 * They'll be replaced by Withemes Parallax & Video Background
 ...
 * $overlay (background)
 */
$el_class = $full_height = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $css = $el_id = $parallax = $parallax_speed = $video_type = $video_url = $mp4 = $webm = $overlay = $align = '';
$disable_element = '';
$output = $after_output = '';
...
if ( $has_parallax ) {
    ...
    if ( $parallax_speed < 0 || $parallax_speed > 1 ) $parallax_speed = 0.5;
